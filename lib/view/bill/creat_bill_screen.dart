...
class CreatBillScreen extends StatefulWidget {

  @override
  _CreatBillScreenState createState() => _CreatBillScreenState();
}

class _CreatBillScreenState extends State<CreatBillScreen> {
